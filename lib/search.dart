...
class MapsUP1Page extends StatefulWidget {
  @override
...
class _MapsUP1Page extends State<MapsUP1Page> {
    ...
    return Scaffold(
      appBar: AppBar(
          ...
          actions: <Widget>[
            ...
            IconButton(
                icon: Icon(Icons.school), onPressed: _goToUNIVERSITY_OF_PHAYAO),
          ]),
      body: GoogleMap(
      ...
      floatingActionButton: Padding(
        padding: const EdgeInsets.only(bottom: 30.0, right: 320.0),
...
//ไปตึกอธิการบดี
  Future _goToUNIVERSITY_OF_PHAYAO() async {
    final GoogleMapController controller = await _controller.future;
    currentLocation = await getCurrentLocation();
    controller
